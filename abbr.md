...
| 5-ALA     | 5-Aminolevulinic Acid                                                                                  | 5-氨基乙酰丙酸                         |
...
| CFS       | Corneal Fluorescence Stain                                                                             | 角膜荧光素染色                         |
| CH        | Chordoma                                                                                               | 脊索瘤                                 |
...
| FBUT      | Fluorescein Tear Break-Up Time                                                                         | 荧光素染色泪膜破裂时间                 |
| FFPE      | Formaldehyde Fixed-Paraffin Embedded                                                                   | 经中性福尔马林固定的石蜡包埋           |
| FIB       | Fibrinogen                                                                                             | 纤维蛋白原                             |
| fMRI      | Functional Mri                                                                                         | 功能 MRI                               |
| FPG       | Fasting Plasma Glucose                                                                                 | 空腹血糖                               |
| FT3       | Free Triiodothyronine                                                                                  | 游离三碘甲腺原氨酸                     |
| FT4       | Free Thyroxine                                                                                         | 游离甲状腺素                           |
| FWS       | Facial Wrinkle Scale                                                                                   | 面部皱纹量表                           |
| GAD       | Generalized Anxiexy Disorde                                                                            | 广泛性焦虑障碍量表                     |
...
| HKA       | Hip-Knee-Ankle Angle                                                                                   | 髋-膝-踝角                             |
...
| iMRI      | Intraoperative Mri                                                                                     | 术中 MRI                               |
...
| NEI       | National Eye Institute                                                                                 | 美国国立眼科研究所                     |
...
| OSDI      | Ocular Surface Disease Index                                                                           | 眼表疾病指数量表                       |
...
| PSA       | Posterior Slope Angle                                                                                  | 后倾角                                 |
|           | Prostate Specific Antigen                                                                              | 前列腺特异抗原                         |
